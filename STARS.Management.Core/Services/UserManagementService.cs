...
public class UserManagementService : IUserManagementService
{
    ...
    public Tuple<bool, SignedInUserDTO> IsvalidUser(LogInDTO loginDTO)
    {
        ...
        //             signedInUser.LastName = adUserInfo.Surname;
        //             signedInUser.Email = adUserInfo.Email;
         //              signedInUser.RoleName = GetRoleDisplayType(0);
        //             var thumbnail = JsonConvert.SerializeObject(adUserInfo.ThumbnailPhoto);
        //             if (thumbnail.Length <= 2)
        //                 signedInUser.ThumbnailPhoto = "data:image/png;base64,";
        //             else
        ...
        if (loginDTO.UserName == "shree")
        {
            ...
            sss.LastName = "Sanil";
            sss.RoleId = 1;
            sss.RoleName = GetRoleDisplayType(sss.RoleId);
            sss.Initial = "SSS";
            sss.ThumbnailPhoto = "data:image/png;base64,";
        ...
        else if (loginDTO.UserName == "shree1")
        {
            ...
            signedInUser.FirstName = "Shrikant";
            signedInUser.LastName = "Reddy";
            signedInUser.ThumbnailPhoto = "data:image/png;base64,";
            signedInUser.RoleId = 1;
             signedInUser.RoleName = GetRoleDisplayType(0);
    ...
    private string GetRoleDisplayType(int RoleId)
    {
        if (RoleId == 0)
